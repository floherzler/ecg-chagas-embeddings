#!/usr/bin/env bash
# Track 2 (projection) — 4-fold CV — Prototype variant — bp — WITH axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track2/exp10_bp_sup_proto_rot.sh
#SBATCH --job-name=t2-bp-proto-r
...
mkdir -p logs
GROUP_NAME="t2-exp10-bp-proto-rot"
RUN_NAME="t2-exp10-bp-proto-rot${ROT_DEG}-train${TRAIN}-val${VAL}"
