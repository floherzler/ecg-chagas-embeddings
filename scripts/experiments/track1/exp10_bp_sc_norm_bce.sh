#!/usr/bin/env bash
# Track 1 (classification) — 4-fold CV — weighted BCE — bp_sc_norm — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track1/exp10_bp_sc_norm_bce.sh
#SBATCH --job-name=t1-bpscn-bcew
...
mkdir -p logs
GROUP_NAME="t1-exp10-bp-sc-norm-bce"
RUN_NAME="t1-exp10-bp-sc-norm-bce-train${TRAIN}-val${VAL}"
