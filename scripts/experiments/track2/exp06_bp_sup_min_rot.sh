#!/usr/bin/env bash
# Track 2 (projection) — 4-fold CV — SupCon MIN (imbalance-aware) — bp — WITH axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track2/exp06_bp_sup_min_rot.sh
#SBATCH --job-name=t2-bp-supmin-r
