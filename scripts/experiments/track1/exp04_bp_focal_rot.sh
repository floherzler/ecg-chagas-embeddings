#!/usr/bin/env bash
# Track 1 (classification) — 4-fold CV — focal loss — bp data — WITH axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track1/exp04_bp_focal_rot.sh
#SBATCH --job-name=t1-bp-focal-rot
