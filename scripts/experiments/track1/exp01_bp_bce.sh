#!/usr/bin/env bash
# Track 1 (classification) — 4-fold CV — weighted BCE — bp — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track1/exp01_bp_bce.sh
#SBATCH --job-name=t1-bp-bcew
...
GROUP_NAME="t1-exp01-bp-bce"
RUN_NAME="t1-exp01-bp-bce-train${TRAIN}-val${VAL}"
