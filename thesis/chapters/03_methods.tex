...
For this thesis, ST-DFT-LRP is computed on a single lead (Lead II; index 1) for all models; lead-importance statistics (mass, entropy, top-$k$) are still computed across all 12 leads from time-domain relevance.
