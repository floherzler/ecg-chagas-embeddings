#!/usr/bin/env bash
# Track 2 (projection) — 4-fold CV — Prototype variant — bp_sc_norm — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track2/exp12_bp_sc_norm_sup_proto.sh
#SBATCH --job-name=t2-bpscn-proto
...
mkdir -p logs
GROUP_NAME="t2-exp12-bp-sc-norm-proto"
RUN_NAME="t2-exp12-bp-sc-norm-proto-train${TRAIN}-val${VAL}"
