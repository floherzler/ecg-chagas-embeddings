#!/usr/bin/env bash
# Track 2 (projection) — 4-fold CV — SupCon MIN (imbalance-aware) — bp — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track2/exp05_bp_sup_min.sh
#SBATCH --job-name=t2-bp-supmin
...
mkdir -p logs
GROUP_NAME="t2-exp05-bp-supmin"
RUN_NAME="t2-exp05-bp-supmin-train${TRAIN}-val${VAL}"
