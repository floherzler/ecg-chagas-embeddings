#!/usr/bin/env bash
# Track 2 (projection) — 4-fold CV — SupCon STANDARD — bp_sc — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track2/exp03_bp_sc_sup_standard.sh
#SBATCH --job-name=t2-bpsc-supstd
...
mkdir -p logs
GROUP_NAME="t2-exp03-bp-sc-supstd"
RUN_NAME="t2-exp03-bp-sc-supstd-train${TRAIN}-val${VAL}"
