#!/usr/bin/env bash
# Track 1 (classification) — 4-fold CV — RAT — bp_sc_norm — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track1/exp12_bp_sc_norm_rat.sh
#SBATCH --job-name=t1-bpscn-rat
...
mkdir -p logs
GROUP_NAME="t1-exp12-bp-sc-norm-rat"
RUN_NAME="t1-exp12-bp-sc-norm-rat-train${TRAIN}-val${VAL}"
