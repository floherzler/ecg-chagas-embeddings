#!/usr/bin/env bash
# Track 2 (projection) — 4-fold CV — SupCon MIN — bp_sc — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track2/exp07_bp_sc_sup_min.sh
#SBATCH --job-name=t2-bpsc-supmin
...
mkdir -p logs
GROUP_NAME="t2-exp07-bp-sc-supmin"
RUN_NAME="t2-exp07-bp-sc-supmin-train${TRAIN}-val${VAL}"
