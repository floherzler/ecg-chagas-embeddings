#!/usr/bin/env bash
# Track 2 (projection) — 4-fold CV — Prototype variant — bp — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track2/exp09_bp_sup_proto.sh
#SBATCH --job-name=t2-bp-proto
...
mkdir -p logs
GROUP_NAME="t2-exp09-bp-proto"
RUN_NAME="t2-exp09-bp-proto-train${TRAIN}-val${VAL}"
