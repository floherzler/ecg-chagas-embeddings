#!/usr/bin/env bash
# Track 1 (classification) — 4-fold CV — focal (gamma=1.5) — bp_sc — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track1/exp08_bp_sc_focal.sh
#SBATCH --job-name=t1-bpsc-focal
...
mkdir -p logs
GROUP_NAME="t1-exp08-bp-sc-focal"
RUN_NAME="t1-exp08-bp-sc-focal-train${TRAIN}-val${VAL}"
