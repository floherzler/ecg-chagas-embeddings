...
\todo{state importance of the disease, prevalence, morbidity/mortality}
...
\section{Electrocardiogram as Screening Modality}
...
\missingfigure{cabrera circle for ecg leads}

\section{Deep Learning for ECG Interpretation}
...
This thesis studies practical strategies to improve robustness under the above constraints, using embedding-space analysis as a diagnostic tool to motivate data harmonization and loss-function choices:
\begin{itemize}
