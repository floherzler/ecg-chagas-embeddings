#!/usr/bin/env bash
# Track 2 (projection) — 4-fold CV — SupCon STANDARD (no imbalance tweaks) — bp — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track2/exp01_bp_sup_standard.sh
#SBATCH --job-name=t2-bp-supstd
...
mkdir -p logs
GROUP_NAME="t2-exp01-bp-supstd"
RUN_NAME="t2-exp01-bp-supstd-train${TRAIN}-val${VAL}"
