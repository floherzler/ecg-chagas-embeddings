#!/usr/bin/env bash
# Track 1 (classification) — 4-fold CV — RAT (Ranking-Aware Tversky) — bp data — WITH axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track1/exp06_bp_rat_rot.sh
#SBATCH --job-name=t1-bp-rat-rot
...
GROUP_NAME="t1-exp06-bp-rat-rot"
RUN_NAME="t1-exp06-bp-rat-rot${ROT_DEG}-train${TRAIN}-val${VAL}"
