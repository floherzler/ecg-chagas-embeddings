#!/usr/bin/env bash
# Track 1 (classification) — 4-fold CV — weighted BCE — bp_sc — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track1/exp07_bp_sc_bce.sh
#SBATCH --job-name=t1-bpsc-bcew
...
mkdir -p logs
GROUP_NAME="t1-exp07-bp-sc-bce"
RUN_NAME="t1-exp07-bp-sc-bce-train${TRAIN}-val${VAL}"
