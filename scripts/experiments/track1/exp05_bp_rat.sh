#!/usr/bin/env bash
# Track 1 (classification) — 4-fold CV — RAT (Ranking-Aware Tversky) — bp data — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track1/exp05_bp_rat.sh
#SBATCH --job-name=t1-bp-rat
...
GROUP_NAME="t1-exp05-bp-rat"
RUN_NAME="t1-exp05-bp-rat-train${TRAIN}-val${VAL}"
