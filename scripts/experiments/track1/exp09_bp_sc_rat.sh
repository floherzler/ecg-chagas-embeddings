#!/usr/bin/env bash
# Track 1 (classification) — 4-fold CV — RAT — bp_sc — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track1/exp09_bp_sc_rat.sh
#SBATCH --job-name=t1-bpsc-rat
...
RUN_NAME="t1-exp09-bp-sc-rat-train${TRAIN}-val${VAL}"
