#!/usr/bin/env bash
# Track 2 (projection) — 4-fold CV — SupCon STANDARD — bp_sc_norm — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track2/exp04_bp_sc_norm_sup_standard.sh
#SBATCH --job-name=t2-bpscn-supstd
