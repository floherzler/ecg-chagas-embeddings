#!/usr/bin/env bash
# Track 1 (classification) — 4-fold CV — focal (gamma=1.5) — bp_sc_norm — no axis rotation
# Usage: sbatch --array=0-3 scripts/experiments/track1/exp11_bp_sc_norm_focal.sh
#SBATCH --job-name=t1-bpscn-focal
...
mkdir -p logs
GROUP_NAME="t1-exp11-bp-sc-norm-focal"
RUN_NAME="t1-exp11-bp-sc-norm-focal-train${TRAIN}-val${VAL}"
